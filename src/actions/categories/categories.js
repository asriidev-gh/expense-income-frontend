...
export const deleteAllCategories = () => async (dispatch) => {
  try {
    const res = await CategoryDataService.removeAll();
...
export const findCategoriesByCategory = (name) => async (dispatch) => {
  try {
    const res = await CategoryDataService.findByCategory(name);
